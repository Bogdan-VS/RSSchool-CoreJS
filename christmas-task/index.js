...
class Garland {
    addColorGarland(class1, class2) {
        const garlandItems = document.querySelectorAll('.garland-item'); // Если ставлю NodeListOf<HTMLElemtnt>, пишет что данный элемент можно только читать.
...
let snowFlag = false;
let init = true;
const snow = new Array(); // 'это маасив из HTMLElement , в которых есть свойства описаные в интерфейсе Isnow. Не понимаю как это корректно протипизировать.
let marginbottom;
let marginright;
let timer;
let i_snow = 0;
...
exports.range = document.getElementById('range'); // Не понятно как протипизироввать, создал интерфейс, но он не получается абсолютно не корректен.
exports.rangeYear = document.getElementById('range-year'); // Аналогичная ситуация
